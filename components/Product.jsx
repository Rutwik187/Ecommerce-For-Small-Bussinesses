      ...
      <Link href={`/product/${slug.current}`}>
        ...
        >
          ...
          <img
            ...
            alt=""
            className=" object-contain transition duration-500 group-hover:scale-105 sm:h-32 m-auto"
          />
          ...
          <div className="relative  py-3 flex justify-between items-center">
            ...
            <button class="flex items-center rounded-md bg-green-400 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-green-500 focus:outline-none focus:ring-4 focus:ring-blue-300">
